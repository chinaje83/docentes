...
abstract class cDepartamentosDB
{
	...
	protected $error;
	/**
	 * Constructor de la clase cDepartamentosDB.
	 *
	...
	/**
	 * Destructor de la clase cDepartamentosDB.
	 */
	function __destruct(){}
	...
	{
		$spnombre="sel_Departamentos_xIdDepartamento";
		$sparam=array(
    ...
    {
        $spnombre="sel_Departamentos_xIdProvincia";
        $sparam=array(
	...
	{
		$spnombre="sel_Departamentos_busqueda_avanzada";
		$sparam=array(
	...
	{
		$spnombre="sel_Departamentos_AuditoriaRapida";
		$sparam=array(
			'pIdDepartamento'=> $datos['IdDepartamento']
		);
		if(!$this->conexion->ejecutarStoredProcedure($spnombre,$sparam,$resultado,$numfilas,$errno) )
	...
	{
		$spnombre="upd_Departamentos_xIdDepartamento";
		$sparam=array(
			'pIdProvincia'=> $datos['IdProvincia'],
			'pNombre'=> $datos['Nombre'],
	...
	{
		$spnombre="del_Departamentos_xIdDepartamento";
		$sparam=array(
			'pIdDepartamento'=> $datos['IdDepartamento']
		);
		if(!$this->conexion->ejecutarStoredProcedure($spnombre,$sparam,$resultado,$numfilas,$errno))
	...
	{
		$spnombre="upd_Departamentos_Estado_xIdDepartamento";
		$sparam=array(
			'pEstado'=> $datos['Estado'],
			'pIdDepartamento'=> $datos['IdDepartamento']
		);
