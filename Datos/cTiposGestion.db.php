<?php 
abstract class cTiposGestionDB
{
	/** @var accesoBDLocal  */
	protected $conexion;
	/** @var mixed  */
	...
	protected $error;
	/**
	 * Constructor de la clase cTiposGestionDB.
	 *
	...
	/**
	 * Destructor de la clase cTiposGestionDB.
	 */
	function __destruct(){}
	...
	{
		$spnombre="sel_TiposGestion_xIdTipoGestion";
		$sparam=array(
			'pIdTipoGestion'=> $datos['IdTipoGestion']
		);
	...
	{
		$spnombre="sel_TiposGestion_busqueda_avanzada";
		$sparam=array(
			'pxNombre'=> $datos['xNombre'],
			'pNombre'=> $datos['Nombre'],
			'pxIdTipoGestionExterno'=> $datos['xIdTipoGestionExterno'],
			'pIdTipoGestionExterno'=> $datos['IdTipoGestionExterno'],
	...
	{
		$spnombre="sel_TiposGestion_AuditoriaRapida";
		$sparam=array(
			'pIdTipoGestion'=> $datos['IdTipoGestion']
		);
		if(!$this->conexion->ejecutarStoredProcedure($spnombre,$sparam,$resultado,$numfilas,$errno) )
	...
	{
		$spnombre="upd_TiposGestion_xIdTipoGestion";
		$sparam=array(
			'pNombre'=> $datos['Nombre'],
			'pIdTipoGestionExterno'=> $datos['IdTipoGestionExterno'],
			'pCodigo'=> $datos['Codigo'],
	...
	{
		$spnombre="del_TiposGestion_xIdTipoGestion";
		$sparam=array(
			'pIdTipoGestion'=> $datos['IdTipoGestion']
		);
		if(!$this->conexion->ejecutarStoredProcedure($spnombre,$sparam,$resultado,$numfilas,$errno))
	...
	{
		$spnombre="upd_TiposGestion_Estado_xIdTipoGestion";
		$sparam=array(
			'pEstado'=> $datos['Estado'],
			'pIdTipoGestion'=> $datos['IdTipoGestion']
		);
