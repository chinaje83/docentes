<?php
abstract class cEscuelasTurnosAGDB
{
	/** @var accesoBDLocal  */
	protected $conexion;
	/** @var mixed  */
	...
	protected $error;
	/**
	 * Constructor de la clase cEscuelasTurnosAGDB.
	 *
	...
	/**
	 * Destructor de la clase cEscuelasTurnosAGDB.
	 */
	function __destruct(){}
	...
	{
		$spnombre="sel_EscuelasTurnosAG_xIdEscuelaTurnoAnioGrado";
		$sparam=array(
    ...
    protected function BuscarxIdEscuelaCiclo(array $datos,  &$resultado, ?int &$numfilas): bool
    {
        $spnombre="sel_EscuelasTurnosAG_xIdEscuelaCiclo";
        $sparam=array(
    ...
    protected function BuscarxIdEscuelaCicloxIdGradoAnio(array $datos,  &$resultado, ?int &$numfilas): bool
    {
        $spnombre="sel_EscuelasTurnosAG_xIdEscuelaCiclo_IdGradoAnio";
        $sparam=array(
            'pIdEscuelaCiclo'=> $datos['IdEscuelaCiclo'],
    ...
    protected function BuscarxIdEscuelaxIdCicloLectivoxIdNivelModalidadxIdTurno(array $datos,  &$resultado, ?int &$numfilas): bool
    {
        $spnombre="sel_EscuelasTurnosAG_xIdEscuela_IdCicloLectivo_IdNivelModalidad_IdTurno";
        $sparam=array(
	...
	{
		$spnombre="sel_EscuelasTurnosAG_busqueda_avanzada";
		$sparam=array(
	...
	{
		$spnombre="sel_EscuelasTurnosAG_AuditoriaRapida";
		$sparam=array(
			'pIdEscuelaTurnoAnioGrado'=> $datos['IdEscuelaTurnoAnioGrado']
		);
		if(!$this->conexion->ejecutarStoredProcedure($spnombre,$sparam,$resultado,$numfilas,$errno) )
	...
	{
		$spnombre="upd_EscuelasTurnosAG_xIdEscuelaTurnoAnioGrado";
		$sparam=array(
			'pIdEscuelaCiclo'=> $datos['IdEscuelaCiclo'],
			'pIdGradoAnio'=> $datos['IdGradoAnio'],
	...
	{
		$spnombre="del_EscuelasTurnosAG_xIdEscuelaTurnoAnioGrado";
		$sparam=array(
			'pIdEscuelaTurnoAnioGrado'=> $datos['IdEscuelaTurnoAnioGrado']
		);
		if(!$this->conexion->ejecutarStoredProcedure($spnombre,$sparam,$resultado,$numfilas,$errno))
	...
	{
		$spnombre="upd_EscuelasTurnosAG_Estado_xIdEscuelaTurnoAnioGrado";
		$sparam=array(
			'pEstado'=> $datos['Estado'],
			'pIdEscuelaTurnoAnioGrado'=> $datos['IdEscuelaTurnoAnioGrado']
		);
