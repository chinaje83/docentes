<?php 
abstract class cTiposLiquidacionDB
{
	/** @var accesoBDLocal  */
	protected $conexion;
	/** @var mixed  */
	...
	{
		$spnombre="sel_TiposLiquidacion_xId";
		$sparam=array(
			'pId'=> $datos['Id']
		);
	...
	{
		$spnombre="sel_TiposLiquidacion_busqueda_avanzada";
		$sparam=array(
	...
	{
		$spnombre="upd_TiposLiquidacion_xId";
		$sparam=array(
			'pNombre'=> $datos['Nombre'],
	...
	{
		$spnombre="del_TiposLiquidacion_xId";
		$sparam=array(
			'pId'=> $datos['Id']
		);
		if(!$this->conexion->ejecutarStoredProcedure($spnombre,$sparam,$resultado,$numfilas,$errno))
	...
	{
		$spnombre="upd_TiposLiquidacion_Estado_xId";
		$sparam=array(
			'pEstado'=> $datos['Estado'],
			'pId'=> $datos['Id']
		);
