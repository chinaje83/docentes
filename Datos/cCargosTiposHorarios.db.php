<?php
abstract class cCargosTiposHorariosdb
{
	/** @var accesoBDLocal  */
	protected $conexion;
	/** @var mixed  */
	...
	protected $error;
	/**
	 * Constructor de la clase cCargosTiposDB.
	 *
	...
	/**
	 * Destructor de la clase cCargosTiposDB.
	 */
	function __destruct(){}
	...
	{
		$spnombre="sel_CargosTiposHorarios_xIdTipoCargo";
		$sparam=array(
	...
	{
		$spnombre="sel_CargosTiposHorarios_busqueda_avanzada";
		$sparam=array(
	...
	{
		$spnombre="sel_CargosTipos_AuditoriaRapida";
		$sparam=array(
    ...
    {
        $spnombre = "sel_CargosTipos_combo";
        $sparam = [];

        if (!$this->conexion->ejecutarStoredProcedure($spnombre,$sparam,$resultado,$numfilas,$errno)) {
            FuncionesPHPLocal::MostrarMensaje($this->conexion,MSG_ERRGRAVE,"Error al buscar al buscar listado. ",array("archivo" => __FILE__,"funcion" => __FUNCTION__, "linea" => __LINE__),array("formato"=>$this->formato));
            return false;
        }
        return true;
    }
	...
	{
		$spnombre="ins_CargosTipos";
		$sparam=array(
			'pNombre'=> $datos['Nombre'],
			'pOrden'=> $datos['Orden'],
			'pEstado'=> $datos['Estado'],
            'pIdCargoCategoria' => $datos["IdCargoCategoria"],
	...
	{
		$spnombre="upd_CargosTipos_xIdTipoCargo";
		$sparam=array(
			'pNombre'=> $datos['Nombre'],
            'pIdCargoCategoria' => $datos["IdCargoCategoria"],
	...
	{
		$spnombre="del_CargosTipos_xIdTipoCargo";
		$sparam=array(
			'pIdTipoCargo'=> $datos['IdTipoCargo']
		);
		if(!$this->conexion->ejecutarStoredProcedure($spnombre,$sparam,$resultado,$numfilas,$errno))
	...
	{
		$spnombre="sel_CargosTipos_max_orden";
		$sparam=array();
		if(!$this->conexion->ejecutarStoredProcedure($spnombre,$sparam,$resultado,$numfilas,$errno) )
		{
	...
	{
		$spnombre="upd_CargosTipos_Orden_xIdTipoCargo";
		$sparam=array(
			'pOrden'=> $datos['Orden'],
			'pIdTipoCargo'=> $datos['IdTipoCargo']
		);
	...
	{
		$spnombre="upd_CargosTipos_Estado_xIdTipoCargo";
		$sparam=array(
			'pEstado'=> $datos['Estado'],
			'pIdTipoCargo'=> $datos['IdTipoCargo']
		);
