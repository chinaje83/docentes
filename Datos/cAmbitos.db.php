...
abstract class cAmbitosDB
{
	...
	protected $error;
	/**
	 * Constructor de la clase cAmbitosDB.
	 *
	...
	/**
	 * Destructor de la clase cAmbitosDB.
	 */
	function __destruct(){}
	...
	{
		$spnombre="sel_Ambitos_xIdAmbito";
		$sparam=array(
	...
	{
		$spnombre="sel_Ambitos_busqueda_avanzada";
		$sparam=array(
			'pxNombre'=> $datos['xNombre'],
			'pNombre'=> $datos['Nombre'],
			'pxIdAmbitoExterno'=> $datos['xIdAmbitoExterno'],
			'pIdAmbitoExterno'=> $datos['IdAmbitoExterno'],
	...
	{
		$spnombre="sel_Ambitos_AuditoriaRapida";
		$sparam=array(
			'pIdAmbito'=> $datos['IdAmbito']
		);
		if(!$this->conexion->ejecutarStoredProcedure($spnombre,$sparam,$resultado,$numfilas,$errno) )
	...
	{
		$spnombre="upd_Ambitos_xIdAmbito";
		$sparam=array(
			'pNombre'=> $datos['Nombre'],
			'pIdAmbitoExterno'=> $datos['IdAmbitoExterno'],
			'pCodigo'=> $datos['Codigo'],
	...
	{
		$spnombre="del_Ambitos_xIdAmbito";
		$sparam=array(
			'pIdAmbito'=> $datos['IdAmbito']
		);
		if(!$this->conexion->ejecutarStoredProcedure($spnombre,$sparam,$resultado,$numfilas,$errno))
	...
	{
		$spnombre="upd_Ambitos_Estado_xIdAmbito";
		$sparam=array(
			'pEstado'=> $datos['Estado'],
			'pIdAmbito'=> $datos['IdAmbito']
		);
