<?php
abstract class cPlanesEducativosDB
{
	/** @var accesoBDLocal  */
	protected $conexion;
	/** @var mixed  */
	...
	protected $error;
	/**
	 * Constructor de la clase cPlanesEducativosDB.
	 *
	...
	/**
	 * Destructor de la clase cPlanesEducativosDB.
	 */
	function __destruct(){}
	...
	{
		$spnombre="sel_PlanesEducativos_xIdPlanEducativo";
		$sparam=array(
	...
	{
		$spnombre="sel_PlanesEducativos_busqueda_avanzada";
		$sparam=array(
    ...
    {
        $spnombre="sel_PlanesEducativos_busqueda_avanzada_csv";
        $sparam=array(
            'pxNombre'=> $datos['xNombre'],
            'pNombre'=> $datos['Nombre'],
            'pxEstado'=> $datos['xEstado'],
	...
	{
		$spnombre="sel_PlanesEducativos_AuditoriaRapida";
		$sparam=array(
			'pIdPlanEducativo'=> $datos['IdPlanEducativo']
		);
		if(!$this->conexion->ejecutarStoredProcedure($spnombre,$sparam,$resultado,$numfilas,$errno) )
	...
	{
		$spnombre="upd_PlanesEducativos_xIdPlanEducativo";
		$sparam=array(
			'pNombre'=> $datos['Nombre'],
            'pIdExterno'=> $datos['IdExterno'],
			'pFechaDesde'=> $datos['FechaDesde'],
	...
	{
		$spnombre="del_PlanesEducativos_xIdPlanEducativo";
		$sparam=array(
			'pIdPlanEducativo'=> $datos['IdPlanEducativo']
		);
		if(!$this->conexion->ejecutarStoredProcedure($spnombre,$sparam,$resultado,$numfilas,$errno))
	...
	{
		$spnombre="sel_PlanesEducativos_max_orden";
		$sparam=array();
		if(!$this->conexion->ejecutarStoredProcedure($spnombre,$sparam,$resultado,$numfilas,$errno) )
		{
	...
	{
		$spnombre="upd_PlanesEducativos_IdPlanEducativo_xIdPlanEducativo";
		$sparam=array(
			'pIdPlanEducativo'=> $datos['IdPlanEducativo'],
			'pIdPlanEducativo'=> $datos['IdPlanEducativo']
		);
	...
	{
		$spnombre="upd_PlanesEducativos_Estado_xIdPlanEducativo";
		$sparam=array(
			'pEstado'=> $datos['Estado'],
			'pIdPlanEducativo'=> $datos['IdPlanEducativo']
		);
