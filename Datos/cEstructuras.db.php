...
abstract class cEstructurasDB
{
	...
	protected $error;
	/**
	 * Constructor de la clase cEstructurasDB.
	 *
	...
	/**
	 * Destructor de la clase cEstructurasDB.
	 */
	function __destruct(){}
	...
	{
		$spnombre="sel_Estructuras_xIdEstructura";
		$sparam=array(
	...
	{
		$spnombre="sel_Estructuras_busqueda_avanzada";
		$sparam=array(
			'pxNombre'=> $datos['xNombre'],
			'pNombre'=> $datos['Nombre'],
			'pxIdEstructuraExterno'=> $datos['xIdEstructuraExterno'],
			'pIdEstructuraExterno'=> $datos['IdEstructuraExterno'],
	...
	{
		$spnombre="sel_Estructuras_AuditoriaRapida";
		$sparam=array(
			'pIdEstructura'=> $datos['IdEstructura']
		);
		if(!$this->conexion->ejecutarStoredProcedure($spnombre,$sparam,$resultado,$numfilas,$errno) )
	...
	{
		$spnombre="upd_Estructuras_xIdEstructura";
		$sparam=array(
			'pNombre'=> $datos['Nombre'],
			'pIdEstructuraExterno'=> $datos['IdEstructuraExterno'],
			'pCodigo'=> $datos['Codigo'],
	...
	{
		$spnombre="del_Estructuras_xIdEstructura";
		$sparam=array(
			'pIdEstructura'=> $datos['IdEstructura']
		);
		if(!$this->conexion->ejecutarStoredProcedure($spnombre,$sparam,$resultado,$numfilas,$errno))
	...
	{
		$spnombre="upd_Estructuras_Estado_xIdEstructura";
		$sparam=array(
			'pEstado'=> $datos['Estado'],
			'pIdEstructura'=> $datos['IdEstructura']
		);
