<?php 
abstract class cNivelesModalidadesDB
{
	/** @var accesoBDLocal  */
	protected $conexion;
	/** @var mixed  */
	...
	protected $error;
	/**
	 * Constructor de la clase cNivelesModalidadesDB.
	 *
	...
	/**
	 * Destructor de la clase cNivelesModalidadesDB.
	 */
	function __destruct(){}
	...
	{
		$spnombre="sel_NivelesModalidades_xIdNivelModalidad";
		$sparam=array(
	...
	{
		$spnombre="sel_NivelesModalidades_busqueda_avanzada";
		$sparam=array(
	...
	{
		$spnombre="sel_NivelesModalidades_AuditoriaRapida";
		$sparam=array(
			'pIdNivelModalidad'=> $datos['IdNivelModalidad']
		);
		if(!$this->conexion->ejecutarStoredProcedure($spnombre,$sparam,$resultado,$numfilas,$errno) )
	...
	{
		$spnombre="ins_NivelesModalidades";
		$sparam=array(
			'pIdNivel'=> $datos['IdNivel'],
			'pIdModalidad'=> $datos['IdModalidad'],
	...
	{
		$spnombre="upd_NivelesModalidades_xIdNivelModalidad";
		$sparam=array(
			'pIdNivel'=> $datos['IdNivel'],
			'pIdModalidad'=> $datos['IdModalidad'],
	...
	{
		$spnombre="del_NivelesModalidades_xIdNivelModalidad";
		$sparam=array(
			'pIdNivelModalidad'=> $datos['IdNivelModalidad']
		);
		if(!$this->conexion->ejecutarStoredProcedure($spnombre,$sparam,$resultado,$numfilas,$errno))
	...
	{
		$spnombre="upd_NivelesModalidades_Estado_xIdNivelModalidad";
		$sparam=array(
			'pEstado'=> $datos['Estado'],
			'pIdNivelModalidad'=> $datos['IdNivelModalidad']
		);
