<?php 
abstract class cNivelesGradosAniosDB
{
	/** @var accesoBDLocal  */
	protected $conexion;
	/** @var mixed  */
	...
	protected $error;
	/**
	 * Constructor de la clase cNivelesGradosAniosDB.
	 *
	...
	/**
	 * Destructor de la clase cNivelesGradosAniosDB.
	 */
	function __destruct(){}
	...
	{
		$spnombre="sel_NivelesGradosAnios_xIdNivelGradoAnio";
		$sparam=array(
	...
	{
		$spnombre="sel_NivelesGradosAnios_busqueda_avanzada";
		$sparam=array(
	...
	{
		$spnombre="sel_NivelesGradosAnios_AuditoriaRapida";
		$sparam=array(
			'pIdNivelGradoAnio'=> $datos['IdNivelGradoAnio']
		);
		if(!$this->conexion->ejecutarStoredProcedure($spnombre,$sparam,$resultado,$numfilas,$errno) )
	...
	{
		$spnombre="ins_NivelesGradosAnios";
		$sparam=array(
			'pIdNivel'=> $datos['IdNivel'],
			'pIdGradoAnio'=> $datos['IdGradoAnio'],
	...
	{
		$spnombre="upd_NivelesGradosAnios_xIdNivelGradoAnio";
		$sparam=array(
			'pIdNivel'=> $datos['IdNivel'],
			'pIdGradoAnio'=> $datos['IdGradoAnio'],
	...
	{
		$spnombre="del_NivelesGradosAnios_xIdNivelGradoAnio";
		$sparam=array(
			'pIdNivelGradoAnio'=> $datos['IdNivelGradoAnio']
		);
		if(!$this->conexion->ejecutarStoredProcedure($spnombre,$sparam,$resultado,$numfilas,$errno))
	...
	{
		$spnombre="upd_NivelesGradosAnios_Estado_xIdNivelGradoAnio";
		$sparam=array(
			'pEstado'=> $datos['Estado'],
			'pIdNivelGradoAnio'=> $datos['IdNivelGradoAnio']
		);
