...
abstract class cBuscadordb
{
	...
	{
		$spnombre="sel_Buscador_xIdBuscador";
		$sparam=array(
	...
	{
		$spnombre="sel_Buscador_busqueda_avanzada";
		$sparam=array(
	...
	{
		$spnombre="sel_Buscador_AuditoriaRapida";
		$sparam=array(
			'pIdBuscador'=> $datos['IdBuscador']
		);
		if(!$this->conexion->ejecutarStoredProcedure($spnombre,$sparam,$resultado,$numfilas,$errno) )
	...
	{
		$spnombre="upd_Buscador_xIdBuscador";
		$sparam=array(
			'pNombre'=> $datos['Nombre'],
			'pDescripcion'=> $datos['Descripcion'],
			'pIdCliente'=> $datos['IdCliente'],
	...
	{
		$spnombre="del_Buscador_xIdBuscador";
		$sparam=array(
			'pIdBuscador'=> $datos['IdBuscador']
		);
		if(!$this->conexion->ejecutarStoredProcedure($spnombre,$sparam,$resultado,$numfilas,$errno))
	...
	{
		$spnombre="upd_Buscador_Estado_xIdBuscador";
		$sparam=array(
			'pEstado'=> $datos['Estado'],
			'pUltimaModificacionUsuario'=> $_SESSION['usuariocod'],
			'pIdBuscador'=> $datos['IdBuscador']
