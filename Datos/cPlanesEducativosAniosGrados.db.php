<?php 
abstract class cPlanesEducativosAniosGradosDB
{
	/** @var accesoBDLocal  */
	protected $conexion;
	/** @var mixed  */
	...
	protected $error;
	/**
	 * Constructor de la clase cPlanesEducativosAniosGradosDB.
	 *
	...
	/**
	 * Destructor de la clase cPlanesEducativosAniosGradosDB.
	 */
	function __destruct(){}
	...
	{
		$spnombre="sel_PlanesEducativosAniosGrados_xIdPlanGradoAnio";
		$sparam=array(
	...
	{
		$spnombre="sel_PlanesEducativosAniosGrados_busqueda_avanzada";
		$sparam=array(
	...
	{
		$spnombre="sel_PlanesEducativosAniosGrados_AuditoriaRapida";
		$sparam=array(
			'pIdPlanGradoAnio'=> $datos['IdPlanGradoAnio']
		);
		if(!$this->conexion->ejecutarStoredProcedure($spnombre,$sparam,$resultado,$numfilas,$errno) )
    ...
    {
        $spnombre="sel_PlanesEducativosAniosGrados_xIdPlanEducativo_xIdGradoAnio";
        $sparam=array(
            'pIdPlanEducativo'=> $datos['IdPlanEducativo'],
            'pIdGradoAnio'=> $datos['IdGradoAnio']
        );
	...
	{
		$spnombre="ins_PlanesEducativosAniosGrados";
		$sparam=array(
			'pIdPlanEducativo'=> $datos['IdPlanEducativo'],
			'pIdGradoAnio'=> $datos['IdGradoAnio'],
			'pEstado'=> $datos['Estado'],
	...
	{
		$spnombre="upd_PlanesEducativosAniosGrados_xIdPlanGradoAnio";
		$sparam=array(
			'pIdPlanEducativo'=> $datos['IdPlanEducativo'],
			'pIdGradoAnio'=> $datos['IdGradoAnio'],
	...
	{
		$spnombre="del_PlanesEducativosAniosGrados_xIdPlanGradoAnio";
		$sparam=array(
			'pIdPlanGradoAnio'=> $datos['IdPlanGradoAnio']
		);
		if(!$this->conexion->ejecutarStoredProcedure($spnombre,$sparam,$resultado,$numfilas,$errno))
	...
	{
		$spnombre="sel_PlanesEducativosAniosGrados_max_orden";
		$sparam=array();
		if(!$this->conexion->ejecutarStoredProcedure($spnombre,$sparam,$resultado,$numfilas,$errno) )
		{
	...
	{
		$spnombre="upd_PlanesEducativosAniosGrados_IdPlanGradoAnio_xIdPlanGradoAnio";
		$sparam=array(
			'pIdPlanGradoAnio'=> $datos['IdPlanGradoAnio'],
			'pIdPlanGradoAnio'=> $datos['IdPlanGradoAnio']
		);
	...
	{
		$spnombre="upd_PlanesEducativosAniosGrados_Estado_xIdPlanGradoAnio";
		$sparam=array(
			'pEstado'=> $datos['Estado'],
			'pIdPlanGradoAnio'=> $datos['IdPlanGradoAnio']
		);
