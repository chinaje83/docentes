<?php 
abstract class cLicenciasAnuladasdb
{
	...
	{
		$spnombre="sel_LicenciasAnuladas_TaskId_FechaModificacion";
		$sparam=array(
	...
	{
		$spnombre="sel_LicenciasAnuladas_busqueda_avanzada";
		$sparam=array(
			'pBaseLicencias'=> BASEDATOSLICENCIAS,
			'pTaskId'=> $datos['TaskId'],
			'plimit'=> $datos['limit'],
	...
	{
		$spnombre="upd_LicenciasAnuladas_IdEstadoProceso_xTaskId_FechaModificacion";
		$sparam=array(
			'pBaseLicencias'=> BASEDATOSLICENCIAS,
	...
	protected function ModificarProcesadaxTaskIdxFechaModificacion($datos)
	{
		$spnombre="upd_LicenciasAnuladas_Procesada_xTaskId_FechaModificacion";
		$sparam=array(
			'pBaseLicencias'=> BASEDATOSLICENCIAS,
			'pProcesada'=> $datos['Procesada'],
			'pTaskId'=> $datos['TaskId'],
			'pFechaModificacion'=> $datos['FechaModificacion']
		);
