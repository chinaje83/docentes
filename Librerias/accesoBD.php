...
class _accesoBDLocal
{
	...
	{
		$this->idconexion = mysql_connect($servidor, $usuariodb, $clave, true) or die("No es posible establecer conexion con la base de datos");
	}
//-----------------------------------------------------------------------------------------
//							 PUBLICAS	
//----------------------------------------------------------------------------------------- 
...
// echo "<br /> ANTES ".$fila['spsqlstring'];		
		...
		if ($sp_nombre=="sel_Empresas_busqueda_avanzada")
		{
			echo $sp_nombre."<br>";
			die();
		}
