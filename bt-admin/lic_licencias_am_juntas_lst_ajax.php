...
foreach($resultado as $i => $fila) {
    ...
    $link .= "<a href=\"javascript:void(0);\" class=\"btn btn-xs btn-info btnEditarJunta\" data-id='{$fila['Id']}' id=\"btnEditarJunta_{$fila['Id']}\" data-toggle=\"tooltip\" data-placement=\"left\" title=\"Ver datos de Junta\" data-estado=\"{$fila['IdEstado']}\"> <i class=\"fas fa-edit\"></i></a>&nbsp;";
