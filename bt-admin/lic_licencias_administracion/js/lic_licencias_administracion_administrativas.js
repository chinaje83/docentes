...
function gridReload(page) {
    ...
    datos["esListadoPendientes"] = 1;
	grid.jqGrid('setGridParam', {
		url: "/licencias/administrativas/revision/lst?rand=" + Math.random(),
		postData: datos,
		page: page
	}).trigger("reloadGrid");
}
	...
	grilla.jqGrid(
		{
			...
			postData: datos,
			datatype: "json",
			colNames: ['Id', 'Agente','Escuela', 'Inicio', 'Fin', 'Duraci\u00f3n', 'Motivo', 'Art\u00edculos', 'Estado p\u00FAblico', 'Fecha de env\u00edo', 'Fecha de reincorporacion', 'Editar','Auditoria'],
			colModel: [
				...
				{name: 'Articulo.Id', index: 'Articulo.Id', width: 40, align: 'left', sortable: false},
				...
				{name: 'FechaReintegro', index: 'FechaReintegro', width: 20, align: 'center', sortable: false},
				{name: 'Editar', index: 'Editar', width: 20, align: 'center', sortable: false},
                {name: 'Editar', index: 'Editar', width: 10, align: 'center', sortable: false}
			],
			rowNum: 20,
