<?php 
include(DIR_CLASES_DB."cLicenciasCircuitosEstadosRolesAcciones.db.php");

class cLicenciasCircuitosEstadosRolesAcciones extends cLicenciasCircuitosEstadosRolesAccionesdb
{
    ...
    public function ActualizarAcciones($datos)
    {
        ...
        $datosbuscar['IdNodoWorkflow'] = $datos['IdNodoWorkflow'];
        if (!$this->EliminarxIdNodoWorkflow($datosbuscar))
            return false;


       $datosinsertar['IdNodoWorkflow'] = $datos['IdNodoWorkflow'];
