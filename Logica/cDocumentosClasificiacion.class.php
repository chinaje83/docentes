<?php 
include(DIR_CLASES_DB."cDocumentosClasificiacion.db.php");

class cDocumentosClasificiacion extends cDocumentosClasificiaciondb
{
	...
	public function Insertar($datos,&$codigoinsertado)
	{
		...
		$oAuditoriasDocumentosClasificiacion = new cAuditoriasDocumentosClasificiacion($this->conexion,$this->formato);
		$datos['IdClasificacion'] = $codigoinsertado;
		$datos['Accion'] = INSERTAR;
		$datos['AltaUsuario'] = $datos['AltaUsuario'];
		$datos['FechaAlta'] = $datos['FechaAlta'];
		if(!$oAuditoriasDocumentosClasificiacion->InsertarLog($datos,$codigoInsertadolog))
			return false;
	...
	public function Modificar($datos)
	{
		...
		if(!$oAuditoriasDocumentosClasificiacion->InsertarLog($datosRegistro,$codigoInsertadolog))
			return false;
	...
	public function Eliminar($datos)
	{
		...
		if(!$oAuditoriasDocumentosClasificiacion->InsertarLog($datosLog,$codigoInsertadolog))
			return false;

		$datosmodif['IdClasificacion'] = $datos['IdClasificacion'];
