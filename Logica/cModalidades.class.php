<?php 
include(DIR_CLASES_DB."cModalidades.db.php");
class cModalidades extends cModalidadesdb
{
	/**
	 * Constructor de la clase cModalidades.
	 *
	...
	/**
	 * Destructor de la clase cModalidades.
	 */
	function __destruct(){
		parent::__destruct();
	}
	...
	public function Insertar($datos,&$codigoInsertado): bool
	{
		...
		if (!parent::Insertar($datos,$codigoInsertado))
			return false;
		$oAuditoriasModalidades = new cAuditoriasModalidades($this->conexion,$this->formato);
		$datos['IdModalidad'] = $codigoInsertado;
		$datos['Accion'] = INSERTAR;
		$datos['AltaUsuario'] = $datos['AltaUsuario'];
		$datos['AltaFecha'] = $datos['AltaFecha'];
		if(!$oAuditoriasModalidades->InsertarLog($datos,$codigoInsertadolog))
			return false;
		return true;
	}
	...
	public function Modificar($datos): bool
	{
		...
		if(!$oAuditoriasModalidades->InsertarLog($datosRegistro,$codigoInsertadolog))
			return false;
		return true;
	}
	...
	public function Eliminar($datos): bool
	{
		...
		if(!$oAuditoriasModalidades->InsertarLog($datosLog,$codigoInsertadolog))
			return false;
		$datosmodif['IdModalidad'] = $datos['IdModalidad'];
...
//-----------------------------------------------------------------------------------------
	...
	private function _ValidarDatosVacios($datos)
	{
        ...
        if (!isset($datos['Codigo']) || $datos['Codigo']=="")
        {
            FuncionesPHPLocal::MostrarMensaje($this->conexion,MSG_ERRGRAVE,"Debe ingresar un codigo",array("archivo" => __FILE__,"funcion" => __FUNCTION__, "linea" => __LINE__),array("formato"=>$this->formato));
            return false;
        }
