...
class cEscalafones extends cEscalafonesdb
{
	...
	public function BusquedaAvanzada($datos,&$resultado,&$numfilas)
	{
        ...
        {
            $sparam['Estado']= implode(",",$datos['Estado']);
            $sparam['xEstado']= 1;
        }
	...
	public function Insertar($datos,&$codigoinsertado)
	{
		...
		$oAuditoriasEscalafones = new cAuditoriasEscalafones($this->conexion,$this->formato);
		$datos['IdEscalafon'] = $codigoinsertado;
		$datos['Accion'] = INSERTAR;
		$datos['AltaUsuario'] = $datos['AltaUsuario'];
		$datos['AltaFecha'] = $datos['AltaFecha'];
		if(!$oAuditoriasEscalafones->InsertarLog($datos,$codigoInsertadolog))
			return false;
	...
	public function Modificar($datos)
	{
		...
		if(!$oAuditoriasEscalafones->InsertarLog($datosRegistro,$codigoInsertadolog))
			return false;
	...
	public function Eliminar($datos)
	{
		...
		if(!$oAuditoriasEscalafones->InsertarLog($datosLog,$codigoInsertadolog))
			return false;

		$datosmodif['IdEscalafon'] = $datos['IdEscalafon'];
...
//-----------------------------------------------------------------------------------------
	...
	private function _ValidarDatosVacios($datos)
	{
		...
		if (!isset($datos['IdEscalafonExterno']) || $datos['IdEscalafonExterno']=="")
		{
			FuncionesPHPLocal::MostrarMensaje($this->conexion,MSG_ERRGRAVE,"Debe ingresar un id escalafón externo",array("archivo" => __FILE__,"funcion" => __FUNCTION__, "linea" => __LINE__),array("formato"=>$this->formato));
			return false;
		}

		if (isset($datos['IdEscalafonExterno']) && $datos['IdEscalafonExterno']!="")
		{
			if (!FuncionesPHPLocal::ValidarContenido($this->conexion,$datos['IdEscalafonExterno'],"NumericoEntero"))
			{
