<?php 
include(DIR_CLASES_DB."cTiposSugerencias.db.php");

class cTiposSugerencias extends cTiposSugerenciasdb
{
	...
	public function Eliminar($datos)
	{
		...
		$datosmodif['IdSugerenciaTipocod'] = $datos['IdSugerenciaTipocod'];
	...
	public function ModificarOrdenCompleto($datos)
	{
		...
		foreach ($arregloOrden as $IdSugerenciaTipocod){
			$datosmodif['IdSugerenciaTipocod'] = $IdSugerenciaTipocod;
...
//-----------------------------------------------------------------------------------------
	...
	private function _ValidarDatosVacios($datos)
	{
		...
		if (!isset($datos['UltimaModificacionApp']) || $datos['UltimaModificacionApp']=="")
		{
			FuncionesPHPLocal::MostrarMensaje($this->conexion,MSG_ERRGRAVE,"Debe ingresar un user",array("archivo" => __FILE__,"funcion" => __FUNCTION__, "linea" => __LINE__),array("formato"=>$this->formato));
			return false;
		}

		if (isset($datos['UltimaModificacionApp']) && $datos['UltimaModificacionApp']!="")
		{
			if (!FuncionesPHPLocal::ValidarContenido($this->conexion,$datos['UltimaModificacionApp'],"FechaDDMMAAAA"))
			{
