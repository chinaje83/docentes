<?php 
include(DIR_CLASES_DB."cNivelesGradosAnios.db.php");
class cNivelesGradosAnios extends cNivelesGradosAniosdb
{
	/**
	 * Constructor de la clase cNivelesGradosAnios.
	 *
	...
	/**
	 * Destructor de la clase cNivelesGradosAnios.
	 */
	function __destruct(){
		parent::__destruct();
	}
	...
	public function Insertar($datos,&$codigoInsertado): bool
	{
		...
		if(!$oAuditoriasNivelesGradosAnios->InsertarLog($datos,$codigoInsertadolog))
			return false;
		return true;
	}
	...
	public function Modificar($datos): bool
	{
		...
		if(!$oAuditoriasNivelesGradosAnios->InsertarLog($datosRegistro,$codigoInsertadolog))
			return false;
		return true;
	}
	...
	public function Eliminar($datos): bool
	{
		...
		if(!$oAuditoriasNivelesGradosAnios->InsertarLog($datosLog,$codigoInsertadolog))
			return false;
		$datosmodif['IdNivelGradoAnio'] = $datos['IdNivelGradoAnio'];
...
//-----------------------------------------------------------------------------------------
	...
	private function _ValidarDatosVacios($datos)
	{
		...
		if (!isset($datos['IdGradoAnio']) || $datos['IdGradoAnio']=="")
		{
			FuncionesPHPLocal::MostrarMensaje($this->conexion,MSG_ERRGRAVE,utf8_decode("Debe seleccionar un grado/año."),array("archivo" => __FILE__,"funcion" => __FUNCTION__, "linea" => __LINE__),array("formato"=>$this->formato));
			return false;
		}
