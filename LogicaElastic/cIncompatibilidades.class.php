...
class Incompatibilidades {
     ...
     * @return bool
     */
    public function validarModulosHorasAtendidos(array $datos, ?array &$resumen, ?int &$total = null, ?array $puestosComputables = []): bool {
        ...
        $jsonData->aggs->Personas->aggs->Resumen->aggs->CargosJerarquicos->filter->bool->filter[1]->terms->Id = $puestosComputables;
        ...
        $jsonData->aggs->Personas->aggs->Resumen->aggs->CargosNoJerarquicos->filter->bool->filter[1]->terms->Id = $puestosComputables;
